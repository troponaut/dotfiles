...
if command_exists "completion-install-zsh"; then
  # completion-install-zsh op
fi

#
# Install 1password cli completion
# - https://developer.1password.com/docs/cli/commands/completion
#
